...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
    ...
    {
        Log.d(TAG, "onShowCustomView: "+isVideoFullscreen);
        if (view instanceof FrameLayout)
        {
            Log.d(TAG, "view instanceof FrameLayout: "+isVideoFullscreen);
            ...
            {
                Log.d(TAG, "focusedChild instanceof android.widget.VideoView: "+isVideoFullscreen);
                // android.widget.VideoView (typically API level <11)
            ...
            {
                Log.d(TAG, "focusedChild Not instanceof android.widget.VideoView: "+isVideoFullscreen);
                ...
                {
                    Log.d(TAG, "webView != null && webView.getSettings().getJavaScriptEnabled() && focusedChild instanceof SurfaceView: "+isVideoFullscreen);
    ...
    public void onHideCustomView()
    {
        ...
        Log.d(TAG, "onHideCustomView: "+isVideoFullscreen);
    ...
    {
        Log.d(TAG, "getVideoLoadingProgressView: "+loadingView.getTransitionName());
        if (loadingView != null)
        {
